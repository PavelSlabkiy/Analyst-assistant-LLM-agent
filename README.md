...
- 🤖 Две LLM: одна пишет код анализа, вторая объясняет результаты по-русски
...
# LLM Model for ответов-пояснений (optional)
...
| `LLM_FORMATTER_MODEL` | Модель для объяснений ответов | `google/gemma-3-4b-it:free` |
