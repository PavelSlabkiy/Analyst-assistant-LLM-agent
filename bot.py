...
• Какой топ-10 специализаций по количеству вакансий?
• Покажи зависимость зарплаты от уровня позиции
...
- Строить графики
- Отвечать на общие вопросы о данных

<b>Советы:</b>
• Будьте конкретны в своих запросах
• Для графиков укажите что именно хотите визуализировать
• Если результат не тот, попробуйте переформулировать вопрос

<b>Примеры хороших вопросов:</b>
✅ "Какая медианная зарплата у Senior разработчиков?"
✅ "Построй гистограмму зарплат для Python разработчиков"
✅ "Сравни зарплаты в Москве и Санкт-Петербурге"

<b>Примеры плохих вопросов:</b>
❌ "Данные" (слишком абстрактно)
❌ "Покажи всё" (нужна конкретика)
"""
...
async def handle_question(message: Message) -> None:
    ...
    try:
        ...
        text_result, image_bytes = await loop.run_in_executor(
            None,
            assistant.ask,
            user_question
        )
